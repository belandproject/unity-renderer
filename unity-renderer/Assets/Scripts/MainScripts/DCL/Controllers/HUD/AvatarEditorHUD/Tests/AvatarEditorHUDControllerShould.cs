...
namespace AvatarEditorHUD_Tests
{
    ...
    {
        private const string EYEBROWS_ID = "urn:beland:off-chain:base-avatars:f_eyebrows_01";
        private const string FEMALE_CATGLASSES_ID = "urn:beland:off-chain:base-avatars:f_glasses_cat_style";
            ...
            userProfile.UpdateData(new UserProfileModel()
            {
                ...
                avatar = new AvatarModel()
                {
                    ...
                    wearables = new List<string>()
                    {
                        ...
                        "urn:beland:off-chain:base-avatars:bear_slippers",
                        "urn:beland:off-chain:base-avatars:f_african_leggins",
                        "urn:beland:off-chain:base-avatars:f_mouth_00",
                        "urn:beland:off-chain:base-avatars:blue_bandana",
                        "urn:beland:off-chain:base-avatars:bee_t_shirt"
                    },
        ...
        public void SaveAvatarProperly()
        {
            ...
            controller.WearableClicked(WearableLiterals.BodyShapes.MALE);
            controller.WearableClicked("urn:beland:off-chain:base-avatars:eyebrows_01");
            controller.WearableClicked("urn:beland:off-chain:base-avatars:eyes_00");
            controller.WearableClicked("urn:beland:off-chain:base-avatars:bear_slippers");
            controller.WearableClicked("urn:beland:off-chain:base-avatars:basketball_shorts");
            controller.WearableClicked("urn:beland:off-chain:base-avatars:mouth_00");
            controller.WearableClicked("urn:beland:off-chain:base-avatars:blue_bandana");
            controller.WearableClicked("urn:beland:off-chain:base-avatars:black_jacket");
