...
public class WearablesVisualTests : VisualTestsBase
{
    ...
    {
        const string EMISSIVE_WEARABLE_ID = "urn:beland:ethereum:collections-v1:dc_niftyblocksmith:blocksmith_feet";
    ...
    {
        const string ALPHA_BLEND_WEARABLE_ID = "urn:beland:ethereum:collections-v1:community_contest:cw_raver_eyewear";
    ...
    {
        const string ALPHA_TEST_WEARABLE_ID = "urn:beland:ethereum:collections-v1:tech_tribal_marc0matic:techtribal_beast_mask";
    ...
    {
        const string WEARABLE_ID = "urn:beland:matic:collections-v2:0x7c688630370a2900960f5ffd7573d2f66f179733:0";
    ...
    {
        const string WEARABLE_ID = "urn:beland:matic:collections-v2:0x3bb75349bfd21176b4e41f8b9afe96b4b86059db:0";
    ...
    {
        const string JACKET_ID = "urn:beland:ethereum:collections-v1:wonderzone_steampunk:steampunk_jacket";
        const string HAT_ID = "urn:beland:ethereum:collections-v1:wonderzone_steampunk:steampunk_hat";
