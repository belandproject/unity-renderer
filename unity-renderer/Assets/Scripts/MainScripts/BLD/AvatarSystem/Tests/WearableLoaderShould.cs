...
namespace Test.AvatarSystem
{
    ...
    {
        private const string GLASSES_WEARABLE_ID = "urn:beland:matic:collections-v2:0x7c688630370a2900960f5ffd7573d2f66f179733:0";
        private const string HOODIE_ID = "urn:beland:off-chain:base-avatars:green_hoodie";
        ...
        private Renderer GetPrimitiveWithAvatarMaterial(Transform parent, string materialName)
        {
            ...
            Material material = new Material(Shader.Find("BLD/Universal Render Pipeline/Lit"))
            {
                name = materialName
            };
