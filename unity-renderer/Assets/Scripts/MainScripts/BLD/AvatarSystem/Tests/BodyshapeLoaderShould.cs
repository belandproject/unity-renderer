...
namespace Test.AvatarSystem
{
    public class BodyshapeLoaderShould
    {
        ...
        private const string EYES_ID = "urn:beland:off-chain:base-avatars:eyes_00";
        private const string EYEBROWS_ID = "urn:beland:off-chain:base-avatars:eyebrows_00";
        private const string MOUTH_ID = "urn:beland:off-chain:base-avatars:mouth_00";
        private const string WEARABLE_SHADER_PATH = "BLD/Universal Render Pipeline/Lit";
