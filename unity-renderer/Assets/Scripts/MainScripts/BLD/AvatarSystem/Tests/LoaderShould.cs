...
namespace Test.AvatarSystem
{
    ...
    {
        private const string FEMALE_ID = "urn:beland:off-chain:base-avatars:BaseFemale";
        private const string EYES_ID = "urn:beland:off-chain:base-avatars:f_eyes_00";
        private const string EYEBROWS_ID = "urn:beland:off-chain:base-avatars:f_eyebrows_00";
        private const string MOUTH_ID = "urn:beland:off-chain:base-avatars:f_mouth_00";
        private static readonly string[] WEARABLE_IDS = new []
        {
            ...
            "urn:beland:off-chain:base-avatars:hair_anime_01",
