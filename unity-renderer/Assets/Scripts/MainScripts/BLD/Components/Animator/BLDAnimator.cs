...
{
    public class BLDAnimator : BaseComponent
    {
        [System.Serializable]
        public class Model : BaseModel
        {
            [System.Serializable]
            public class BLDAnimationState
            {
                public string name;
                public string clip;
                ...
                public BLDAnimationState Clone() { return (BLDAnimationState) this.MemberwiseClone(); }
            }

            public BLDAnimationState[] states;
        ...
        private void OnEntityShapeLoaded(IBLDEntity shapeEntity)
        {
        ...
        void UpdateAnimationState()
        {
            ...
            {
                Model.BLDAnimationState state = model.states[i];
        ...
        public void ResetAnimation(Model.BLDAnimationState state)
        {
        ...
        public Model.BLDAnimationState GetStateByString(string stateName)
        {
            Model model = (Model) this.model;
