...
public class BLDCharacterController : MonoBehaviour
{
    public static BLDCharacterController i { get; private set; }
    ...
    public BLDCharacterPosition characterPosition;
    ...
    public static System.Action<BLDCharacterPosition> OnCharacterMoved;
    ...
    void Awake()
    {
        ...
        characterPosition = new BLDCharacterPosition();
    ...
    internal void LateUpdate()
    {
        ...
        if ((BLDTime.realtimeSinceStartup - lastMovementReportTime) > PlayerSettings.POSITION_REPORTING_DELAY)
        {
            ReportMovement();
        }
    ...
    void ReportMovement()
    {
        ...
        if (initialPositionAlreadySet)
            BLD.Interface.WebInterface.ReportPosition(reportPosition, compositeRotation, playerHeight, cameraRotation);

        lastMovementReportTime = BLDTime.realtimeSinceStartup;
    }
