...
public static class ExploreEventsUtils
{
    ...
    internal const string EVENT_DETAIL_URL = "https://events.beland.io/event/?id={0}";
    ...
    internal static string FormatEventPlace(EventFromAPIModel eventFromAPI) { return string.IsNullOrEmpty(eventFromAPI.scene_name) ? "Beland" : eventFromAPI.scene_name; }
