...
namespace AvatarEditorHUD_Tests
{
    public class AvatarEditorHUDViewShould : IntegrationTestSuite_Legacy
    {
        ...
        [Test]
        [TestCase("urn:beland:off-chain:base-avatars:f_african_leggins", WearableLiterals.BodyShapes.FEMALE)]
        [TestCase("urn:beland:off-chain:base-avatars:eyebrows_02", WearableLiterals.BodyShapes.MALE)]
        ...
        [Test]
        [TestCase("urn:beland:off-chain:base-avatars:f_african_leggins", WearableLiterals.BodyShapes.MALE)]
        [TestCase("urn:beland:off-chain:base-avatars:eyebrows_02", WearableLiterals.BodyShapes.FEMALE)]
        ...
        [Test]
        [TestCase("urn:beland:off-chain:base-avatars:f_mouth_00")]
        [TestCase("urn:beland:off-chain:base-avatars:bee_t_shirt")]
        [TestCase("urn:beland:off-chain:base-avatars:m_mountainshoes.glb")]
        [TestCase("urn:beland:off-chain:base-avatars:moptop")]
        ...
        [Test]
        [TestCase("urn:beland:halloween_2019:sad_clown_upper_body")]
        ...
        {
            var wearableId = "urn:beland:halloween_2019:sad_clown_upper_body";
            userProfile.SetInventory(new[] {wearableId});
            userProfile.UpdateData(new UserProfileModel()
            {
                name = "name",
