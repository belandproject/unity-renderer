...
public class AvatarEditorHUDController : IHUD
{
    ...
    private const string URL_MARKET_PLACE = "https://market.beland.io/list?limit=10&offset=0&string_type__in=wearable";
    private const string URL_GET_A_WALLET = "https://docs.beland.io/get-a-wallet";
    private const string URL_SELL_COLLECTIBLE_GENERIC = "https://market.beland.io/account";
    private const string URL_SELL_SPECIFIC_COLLECTIBLE = "https://market.beland.io/contracts/{collectionId}/tokens/{tokenId}";
