...
{
    private const string GRAPHIC_CARD_MESSAGE = "Your machine is not using a dedicated graphics card to run Beland. This might lead to performance issues. Check your browser and OS configuration.";
