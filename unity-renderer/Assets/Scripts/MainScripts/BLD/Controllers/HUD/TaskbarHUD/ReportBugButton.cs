...
namespace MainScripts.DCL.Controllers.HUD.TaskbarHUD
{
    ...
    {
#if UNITY_WEBGL
        private const string ReportBugURL = "https://github.com/belandproject/issues/issues/new?assignees=&labels=new%2Cexplorer&template=bug_report.yml";
#else
        private const string ReportBugURL = "https://github.com/belandproject/explorer-desktop/issues/new?assignees=&labels=new%2Cexplorer&template=bug_report.yml";
#endif
