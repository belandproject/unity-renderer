...
{
    public string dataTrackingURL = "https://tracking.beland.io/track";
    ...
    void Start()
    {
        ...
        // FULL GLB
        TestUtils.InstantiateEntityWithShape(scene, "1", BLD.Models.CLASS_ID.GLTF_SHAPE, new Vector3(-2.5f, 1, 0),
            TestAssetsUtils.GetPath() + "/GLB/Trunk/Trunk.glb");

        // GLB + Separated Textures
        TestUtils.InstantiateEntityWithShape(scene, "2", BLD.Models.CLASS_ID.GLTF_SHAPE, new Vector3(0f, 1, 0),
            TestAssetsUtils.GetPath() + "/GLB/TrunkSeparatedTextures/Trunk.glb");

        // GLTF
        TestUtils.InstantiateEntityWithShape(scene, "3", BLD.Models.CLASS_ID.GLTF_SHAPE, new Vector3(2.5f, 1, 0),
