...
public class GPUSkinningVisualTests : VisualTestsBase
{
    ...
    public IEnumerator Basic()
    {
        ...
        yield return LoadWearable("urn:beland:off-chain:base-avatars:bee_t_shirt", WearableLiterals.BodyShapes.FEMALE, originalGO, originalCombiner);
        ...
        yield return LoadWearable("urn:beland:off-chain:base-avatars:bee_t_shirt", WearableLiterals.BodyShapes.FEMALE, gpuSkinningGO, gpuSkinningCombiner);
