...
namespace DCL
{
    public static class AssetBundleMenuItems
    {
        ...
        [MenuItem("Beland/Asset Bundle Builder/Dump Default Empty Parcels")]
        public static void DumpEmptyParcels_Default() { DumpEmptyParcels(); }

        [MenuItem("Beland/Asset Bundle Builder/Dump Halloween Empty Parcels")]
        public static void DumpEmptyParcels_Halloween() { DumpEmptyParcels("halloween"); }
        
        [MenuItem("Beland/Asset Bundle Builder/Dump XMas Empty Parcels")]
        ...
        [MenuItem("Beland/Asset Bundle Builder/Dump All Body-Wearables")]
        public static void DumpAllBodiesWearables() { ABConverter.WearablesCollectionClient.DumpAllBodyshapeWearables(); }

        [MenuItem("Beland/Asset Bundle Builder/Dump All Non-Body-Wearables (Optimized)")]
        public static void DumpAllNonBodiesWearables() { ABConverter.WearablesCollectionClient.DumpAllNonBodyshapeWearables(); }
        
        [MenuItem("Beland/Asset Bundle Builder/Dump Single Wearables Collection")]
        public static void DumpSingleWearablesCollection() { ABConverter.WearablesCollectionClient.DumpSingleWearablesCollection("urn:beland:ethereum:collections-v1:atari_launch"); }

        [MenuItem("Beland/Start Visual Tests")]
        public static void StartVisualTests() { EditorCoroutineUtility.StartCoroutineOwnerless(VisualTests.TestConvertedAssets()); }

        [MenuItem("Beland/Asset Bundle Builder/Dump Org -110,-110")]
        public static void DumpArea() { ABConverter.SceneClient.DumpArea(new Vector2Int(-110, -110), new Vector2Int(1, 1)); }

        [MenuItem("Beland/Asset Bundle Builder/Dump scene QmXMzPLZNx5EHiYi3tK9MT5g9HqjAqgyAoZUu2LfAXJcSM")]
        public static void DumpSceneId() { ABConverter.SceneClient.DumpScene("QmXMzPLZNx5EHiYi3tK9MT5g9HqjAqgyAoZUu2LfAXJcSM"); }

        [MenuItem("Beland/Asset Bundle Builder/Dump Single Asset")]
        ...
        [MenuItem("Beland/Asset Bundle Builder/Only Build Bundles")]
