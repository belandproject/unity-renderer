...
namespace BLD.ABConverter
{
    ...
    {
        [Test]
        public void CIDtoGuidTest() { Assert.AreEqual("d3b55cc7e3367537c1670ecebb1ccb05", BLD.ABConverter.Utils.CidToGuid("QmWVcyTEzSEBKC7hzq6doiTWnopZ6DdqJMqufx6gXwFnTS")); }
